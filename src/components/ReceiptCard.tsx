...
export const ReceiptCard: React.FC<ReceiptProps> = ({ data }) => {
  ...
  return (
    <div ref={containerRef} className="w-full flex justify-center py-4 no-print overflow-hidden">
      <div 
        className="relative shadow-2xl rounded-sm overflow-hidden bg-white origin-top"
        style={{
          width: '210mm',
          height: `${105 * scale}mm`,
          minWidth: '210mm',
      ...
      >
        <div 
          ref={receiptRef}
          className="relative w-[210mm] h-[105mm] border-2 border-brand-primary p-6 bg-white flex flex-col font-sans"
        >
          {/* Side Label */}
          ...
          <div className="ml-12 flex-1 flex flex-col">
            ...
            <div className="mt-auto flex justify-between items-end pb-2">
              ...
              <div className="flex flex-col items-center">
                ...
                <p className="text-[8px] mt-1 text-gray-400 tracking-tighter" data-html2canvas-ignore="true">Scan to Verify</p>
              </div>
              ...
              <div className="flex flex-col items-center text-right">
                ...
                <button 
                  ...
                  className="mt-4 no-print bg-green-500 text-white text-[10px] px-3 py-1 rounded-full font-bold flex items-center gap-1 hover:bg-green-600 transition-all shadow-sm"
                >
      ...
      {/* Print View (Hidden in Web) */}
      <div className="hidden print:block">
        <div 
          ref={receiptRef}
          className="w-[210mm] h-[105mm] border-2 border-brand-primary p-6 bg-white flex flex-col font-sans"
        >
           {/* Same content for printing */}
           <div className="absolute left-0 top-0 bottom-0 w-12 bg-brand-primary flex items-center justify-center">
            <span className="transform -rotate-90 whitespace-nowrap text-white font-bold text-2xl tracking-widest">
              KWITANSI
            </span>
          ...
          <div className="ml-12 flex-1 flex flex-col">
            <div className="flex items-start justify-between border-b-2 border-brand-primary pb-2">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h1 className="text-lg font-extrabold text-brand-secondary leading-tight uppercase">Paguyuban Dharma Putra Mahesa</h1>
                  <p className="text-sm font-semibold text-brand-secondary">DESA KALIKEBO</p>
                </div>
              </div>
              <div className="text-right">
            ...
            <div className="mt-4 space-y-3 flex-1">
              <div className="flex items-baseline gap-2">
                <span className="text-sm font-bold min-w-[120px]">Telah diterima :</span>
                <span className="flex-1 border-b border-dotted border-gray-400 font-medium italic">{data.nama_donatur}</span>
              </div>
              <div className="flex items-baseline gap-2">
                <span className="text-sm font-bold min-w-[120px]">Uang sebesar :</span>
                <span className="flex-1 border-b border-dotted border-gray-400 font-bold text-lg">{formatCurrency(data.nominal)}</span>
              </div>
              <div className="flex items-start gap-2">
                <span className="text-sm font-bold min-w-[120px]">Terbilang :</span>
                <div className="flex-1 bg-brand-primary/10 p-2 rounded italic font-medium">{terbilangIndonesia(data.nominal)}</div>
              </div>
              <div className="flex items-baseline gap-2">
                <span className="text-sm font-bold min-w-[120px]">Untuk Pembayaran :</span>
                <span className="flex-1 border-b border-dotted border-gray-400">{data.keperluan}</span>
              </div>
            </div>
            ...
            <div className="mt-auto flex justify-between items-end pb-2">
              ...
              <div className="flex flex-col items-center text-right">
                <p className="text-[10px] font-bold mb-1">Kalikebo, {data.tanggal}</p>
                <p className="text-[10px] font-bold mb-6 uppercase text-gray-400">Bendahara</p>
                <p className="text-sm font-bold uppercase underline min-w-[100px] text-center">{data.bendahara}</p>
              </div>
            </div>
