...
export const ReceiptCard: React.FC<ReceiptProps> = ({ data }) => {
  ...
  const handleDownloadPDF = async () => {
    ...
    // Ukuran Kwitansi: 210mm (A4 width) x 105mm (custom height)
    const pdf = new jsPDF({
  ...
  return (
    <div 
      ref={receiptRef}
      className="relative w-[210mm] h-[105mm] border-2 border-brand-primary p-6 bg-white overflow-hidden flex flex-col font-sans"
    >
      {/* Side Label */}
